...
\newcommand{\myTitle}{Machine learning for ancient Greek linguistics\xspace}
\newcommand{\mySubTitle}{A tentative methodology and application to the corpus of documentary papyri\xspace}
